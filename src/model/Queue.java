 ...
 * nodes. See LinkedQueue for the version from the textbook that uses a non-static nested class. See
 * ResizingArrayQueue for a version that uses a resizing array. The <em>enqueue</em>,
